...
import { getManuals } from "../../api/api";

import "./ManualList.css";

/**
 * Componente ManualList — Muestra el listado de manuales indexados o pendientes.
 * Carga los datos desde el servidor utilizando la API centralizada y permite visualizar métricas como páginas y fragmentos.
 */
function ManualList({ refresh }) {
    ...
    // Efecto para cargar los manuales al montar el componente
    // o cuando cambia la prop 'refresh'
    useEffect(() => {

        // Función asíncrona interna para gestionar la llamada centralizada a la API de manuales
        const loadManuals = async () => {

            try {

                // Petición al backend usando la API centralizada para obtener los manuales
